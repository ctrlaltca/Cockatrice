...
CardInfoWidget::CardInfoWidget(const QString &cardName, const QString &cardHash, QWidget *parent, Qt::WindowFlags flags)
...
void CardInfoWidget::setCard(const QString &cardName, const QString &cardHash)
{
    if(!cardHash.isEmpty())
